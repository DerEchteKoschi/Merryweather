...
class PasswordValidationContainer
{
    public function __construct(
        ...
        #[Assert\NotBlank(message: 'Das Kennwort darf nicht leer sein')]
        #[Assert\NotNull(message: 'Das Kennwort darf nicht leer sein')]
        ...
        ], message: 'Das neue Kennwort darf nicht mit dem alten Kennwort übereinstimmen')]
        #[Assert\NotNull(message: 'Das aktuelle Kennwort darf nicht leer sein')]
